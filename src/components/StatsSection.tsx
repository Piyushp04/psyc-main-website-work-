    ...
    <section className="py-20 md:py-32 bg-[#0F131A] text-white relative overflow-hidden">
      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          ...
          <AnimatedStat value={96} suffix="%" description="Reduction in human injuries during operations" color="bg-gradient-to-r from-amber-400 to-amber-600" />
          <AnimatedStat value={91} suffix="%" description="Tranquilization success rate in test operations" color="bg-gradient-to-r from-amber-600 to-psyc-orange" />
        </div>
