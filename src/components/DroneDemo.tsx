            ...
            <div className="absolute inset-0 p-4">
              ...
              >
                <div className={`w-32 h-24 relative ${currentStep === 4 ? 'opacity-70' : 'opacity-100'}`}>
                  ...
                  {currentStep === 1 && (
                    <div className="absolute -top-15 -left-16 bg-black/70 backdrop-blur-md rounded-lg p-2 border border-white/10 text-xs font-mono text-green-400 animate-fade-in">
                      <div>ANALYSIS:</div>
                      <div>Weight: 4.2T</div>
                      <div>Age: Adult</div>
                      <div>Health: Good</div>
                  ...
                  {currentStep === 4 && (
                    <div className="absolute -top-18 -right-18 bg-black/70 backdrop-blur-md rounded-lg p-3 border border-white/10 text-xs font-mono text-green-400 animate-fade-in cyber-border">
              ...
              <div className="absolute bottom-3 left-3 bg-black/60 px-2 py-1 rounded text-xs text-white/70 font-mono">
                COORDINATES: 2°31'12"S 34°49'55"E
              </div>
